...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-port=<port>", strprintf(_("Listen for connections on <port> (default: %u or testnet: %u)"), 30555, 11945));
    ...
    strUsage += HelpMessageOpt("-litemode=<n>", strprintf(_("Disable all LivenodesCoin specific functionality (Masternodes, Obfuscation, SwiftX) (0-1, default: %u)"), 0));
